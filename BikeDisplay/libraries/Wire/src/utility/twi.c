/*
  ...
  Modified 2024 by Tim Abler to use timeouts
*/
...
static volatile uint32_t twi_timeout_us = 25000ul; // -> changed by Tim
static volatile bool twi_timed_out_flag = false;  // a timeout has been seen
static volatile bool twi_do_reset_on_timeout = true;  // reset the TWI registers on timeout -> changed by TIm
